    ...
    <div class="">
      <div class="page-title">
          <div class="title_left">
            <h3>Data User
              <small>yang sudah aktif.</small></h3>
          </div>
                    ...
                    <tbody>
                      ...
                      @foreach ($data as $key=>$item)
                        ...
                        <tr>
                            ...
                            <td>
                              <a data-href="{{route('user.change-status',$item->id)}}" data-status="{{$item->active}}" data-toggle="modal" data-target="#confirm-user" class="btn btn-danger btn-xs"><i class="fa fa-close"></i> Nonaktif </a>
                            </td>
                        </tr>
                      @endforeach
                    </tbody>
